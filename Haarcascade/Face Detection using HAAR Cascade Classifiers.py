...
face_classifier = cv2.CascadeClassifier(r"C:\Users\WELCOME\Desktop\Python\Haarcascade\Haarcascades\haarcascade_frontalface_default.xml")
# Load the image
image = cv2.imread(r"C:\Users\WELCOME\Desktop\Python\Mood_Class_classification_using CNN\Training\Not Happy\imag.jpg")
