...
model = pickle.load(open(r'C:\Users\WELCOME\Desktop\Python\linear_regression\linear_regression_model.pkl', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.built model by Pooja Sharma")
